...
export interface Query {
  ...
  GetRtcToken: GetRtcTokenResponse;
}
...
export interface GetRtcTokenQueryArgs {
  channelName: string;
}
...
export interface Mutation {
  ...
  FindVoiceUser: FindVoiceUserResponse;
}
